# Agent 1 Brief — run test-par-3

You are executor 1 of 3 in a `chart-test-swarm` run.

- **Project:**    `/Users/rohit/Documents/chart-test-swarm/examples/sample-product-chart`
- **Run dir:**    `reports/test-par-3/`
- **Your dir:**   `reports/test-par-3/agent-1/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/test-par-3/agent-1/result.yaml` using this schema:
