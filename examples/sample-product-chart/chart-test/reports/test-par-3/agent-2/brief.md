# Agent 2 Brief — run test-par-3

You are executor 2 of 3 in a `chart-test-swarm` run.

- **Project:**    `/Users/rohit/Documents/chart-test-swarm/examples/sample-product-chart`
- **Run dir:**    `reports/test-par-3/`
- **Your dir:**   `reports/test-par-3/agent-2/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/test-par-3/agent-2/result.yaml` using this schema:
