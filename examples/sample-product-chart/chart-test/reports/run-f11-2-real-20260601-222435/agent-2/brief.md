# Agent 2 Brief — run run-f11-2-real-20260601-222435
...
- **Run dir:**    `reports/run-f11-2-real-20260601-222435/`
- **Your dir:**   `reports/run-f11-2-real-20260601-222435/agent-2/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/run-f11-2-real-20260601-222435/agent-2/result.yaml` using this schema:

   ```yaml
   agent: 2
   run_id: run-f11-2-real-20260601-222435
   results:
