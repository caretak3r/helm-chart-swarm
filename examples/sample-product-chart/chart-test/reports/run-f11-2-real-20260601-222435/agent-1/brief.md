# Agent 1 Brief — run run-f11-2-real-20260601-222435
...
- **Your dir:**   `reports/run-f11-2-real-20260601-222435/agent-1/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/run-f11-2-real-20260601-222435/agent-1/result.yaml` using this schema:
