# Agent 1 Brief — run run-20260601-095045-12589
...
- **Run dir:**    `reports/run-20260601-095045-12589/`
- **Your dir:**   `reports/run-20260601-095045-12589/agent-1/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/run-20260601-095045-12589/agent-1/result.yaml` using this schema:

   ```yaml
   agent: 1
   run_id: run-20260601-095045-12589
   results:
