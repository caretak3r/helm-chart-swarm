# Agent 2 Brief — run run-20260601-095045-12589
...
- **Your dir:**   `reports/run-20260601-095045-12589/agent-2/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/run-20260601-095045-12589/agent-2/result.yaml` using this schema:
