# Agent 1 Brief — run run-20260601-095403-17465
...
- **Your dir:**   `reports/run-20260601-095403-17465/agent-1/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/run-20260601-095403-17465/agent-1/result.yaml` using this schema:
