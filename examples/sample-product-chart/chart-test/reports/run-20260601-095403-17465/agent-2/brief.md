# Agent 2 Brief — run run-20260601-095403-17465
...
- **Run dir:**    `reports/run-20260601-095403-17465/`
- **Your dir:**   `reports/run-20260601-095403-17465/agent-2/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/run-20260601-095403-17465/agent-2/result.yaml` using this schema:

   ```yaml
   agent: 2
   run_id: run-20260601-095403-17465
   results:
