# Agent 1 Brief — run run-20260601-095025-12109
...
- **Your dir:**   `reports/run-20260601-095025-12109/agent-1/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/run-20260601-095025-12109/agent-1/result.yaml` using this schema:
