# Agent 2 Brief — run run-20260601-095025-12109
...
- **Run dir:**    `reports/run-20260601-095025-12109/`
- **Your dir:**   `reports/run-20260601-095025-12109/agent-2/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/run-20260601-095025-12109/agent-2/result.yaml` using this schema:

   ```yaml
   agent: 2
   run_id: run-20260601-095025-12109
   results:
