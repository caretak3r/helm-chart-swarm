# Agent 2 Brief — run test-backend-minikube
...
- **Run dir:**    `reports/test-backend-minikube/`
- **Your dir:**   `reports/test-backend-minikube/agent-2/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/test-backend-minikube/agent-2/result.yaml` using this schema:

   ```yaml
   agent: 2
   run_id: test-backend-minikube
   results:
