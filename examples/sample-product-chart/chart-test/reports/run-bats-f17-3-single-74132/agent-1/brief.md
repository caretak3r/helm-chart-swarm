# Agent 1 Brief — run run-bats-f17-3-single-74132
...
- **Run dir:**    `reports/run-bats-f17-3-single-74132/`
- **Your dir:**   `reports/run-bats-f17-3-single-74132/agent-1/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/run-bats-f17-3-single-74132/agent-1/result.yaml` using this schema:

   ```yaml
   agent: 1
   run_id: run-bats-f17-3-single-74132
   results:
