# Agent 2 Brief — run run-20260601-090930-39876
...
- **Your dir:**   `reports/run-20260601-090930-39876/agent-2/`
...
2. Aggregate your scenarios' results into a single `result.yaml` at
   `reports/run-20260601-090930-39876/agent-2/result.yaml` using this schema:
